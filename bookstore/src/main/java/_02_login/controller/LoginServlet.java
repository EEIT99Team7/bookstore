...
import _02_login.model.ILoginServiceDAO;
...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ILoginServiceDAO loginService	= 
				ctx.getBean(ILoginServiceDAO.class);

		password = GlobalService.getMD5Endocing(GlobalService.encryptString(password));
		// 呼叫 loginService物件的 checkIDPassword()，傳入userid與password兩個參數
		MemberBean mb = loginService.checkIDPassword(userId, password);
